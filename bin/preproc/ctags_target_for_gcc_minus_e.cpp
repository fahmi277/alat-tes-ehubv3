...
*/
# 87 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
 ...
 */
# 112 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
 ...
 */
# 152 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
bool CANInit(BITRATE bitrate, int remap)
{
  ...
  while (!(((CAN_TypeDef *)(0x40000000UL /*!< Peripheral base address in the alias region */ + 0x00006400UL))->MSR & 0x1UL)); // Wait for Initialization mode
...
# 285 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
/**
 ...
 */
# 293 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
void CANReceive(CAN_msg_t* CAN_rx_msg)
{
  uint32_t id = ((CAN_TypeDef *)(0x40000000UL /*!< Peripheral base address in the alias region */ + 0x00006400UL))->sFIFOMailBox[0].RIR;
  if ((id & (1U << 2U) /* Bit 2: Identifier Extension*/) == 0) { // Standard frame format
  ...
  if ((id & (1U << 1U) /* Bit 1: Remote Transmission Request*/) == 0) { // Data frame
 ...
 */
# 336 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
 ...
 */
# 386 "d:\\Sundaya\\File JS Pro\\Ehub V3\\code\\EHUB V3 tes board\\tesBoard\\tesBoard.ino"
